...
from bpy.props import StringProperty, IntProperty, FloatProperty, BoolProperty, FloatVectorProperty, PointerProperty, EnumProperty
  ...
  def draw(self, context):
    if bpy.context.selected_objects:
      ...
      for i, anim in enumerate(context.object.material_animations):
        ...
        row2 = col.row()
        row2.prop(context.object.material_animations[i], "frame_width")
        row2.prop(context.object.material_animations[i], "frame_height")
        row2.prop(context.object.material_animations[i], "frame_duration")
        row3 = col.row()
        row3.prop(context.object.material_animations[i], "num_col")
        row3.prop(context.object.material_animations[i], "num_row")
        row3.prop(context.object.material_animations[i], "num_frames")        
      #endfor
      ...
      layout.prop(selected_object.mat_properties, "light_group")
      ...
      layout.prop(selected_object.mat_properties, "blend")
      ...
      layout.prop(selected_object.mat_properties, "texture_scale")
      layout.prop(selected_object.mat_properties, "texture_blend_mode")
      layout.prop(selected_object.mat_properties, "secondary_texture")
      layout.prop(selected_object.mat_properties, "secondary_texture_scroll_angle")
      layout.prop(selected_object.mat_properties, "secondary_texture_scroll_rate")
      layout.prop(selected_object.mat_properties, "secondary_texture_scale")
      layout.prop(selected_object.mat_properties, "secondary_texture_blend_mode")
      ...
      layout.prop(selected_object.mat_properties, "displacement_map_scale")
      ...
      layout.prop(selected_object.mat_properties, "dissolve_texture")
      layout.prop(selected_object.mat_properties, "dissolve_texture_scroll_angle")
      layout.prop(selected_object.mat_properties, "dissolve_texture_scroll_rate")
      layout.prop(selected_object.mat_properties, "dissolve_texture_scale")
      layout.prop(selected_object.mat_properties, "dissolve_glow")
      layout.prop(selected_object.mat_properties, "dissolve_glow_range")
      layout.prop(selected_object.mat_properties, "dissolve_glow_falloff")
      layout.prop(selected_object.mat_properties, "dissolve_amount")
      layout.prop(selected_object.mat_properties, "decal_enabled_flag")
      layout.prop(selected_object.mat_properties, "decal_group")
      ...
      layout.prop(selected_object.mat_properties, "distance_alpha_blend")
...
class MaterialAnimation(bpy.types.PropertyGroup):
  name: bpy.props.StringProperty(name="Texture Target")
...
class WARME_PG_MatProperties(bpy.types.PropertyGroup):
  ...
  light_group: IntProperty(
    name="Light group",
    description="Light group identifier",
    default=0
  )
  ...
  blend: FloatVectorProperty(
    name="Blend color",
    description="Blend color for the material",
    subtype='COLOR',
    size=4,
  ...
  texture_scale: FloatVectorProperty(
    name="Texture scale",
    description="Texture scale for the material",
    default=(1.0, 1.0),
    subtype='NONE',
    size=2,
    min=0.0, max=1.0
  )
  texture_blend_mode: EnumProperty(
    name="Texture blend mode",
    items=[
      ('MUL', "MUL", "Multiply Blending Mode"),
      ('MIX', "MIX", "Mix Blending Mode")
    ],
    description="Texture blend mode for the material",
    default='MUL'
  )
  secondary_texture: StringProperty(
    name="Secondary texture",
    description="Secondary texture for the material",
    default="",
    subtype='FILE_PATH'
  )
  secondary_texture_scroll_angle: FloatProperty(
    name="Secondary texture scroll angle",
    description="Secondary texture scroll angle for the material",
    default=0
  )
  secondary_texture_scroll_rate: FloatProperty(
    name="Secondary texture scroll rate",
    description="Secondary texture scroll rate for the material",
    default=0
  )
  secondary_texture_scale: FloatVectorProperty(
    name="Secondary texture scale",
    description="Secondary texture scale for the material",
    default=(1.0, 1.0),
    subtype='NONE',
    size=2,
    min=0.0, max=1.0
  )
  secondary_texture_blend_mode: EnumProperty(
    name="Secondary texture blend mode",
    items=[
      ('MUL', "MUL", "Multiply Blending Mode"),
      ('MIX', "MIX", "Mix Blending Mode")
    ],
    description="Secondary texture blend mode for the material",
    default='MUL'
  )
  ...
  displacement_map_scale: FloatVectorProperty(
    name="Displacement texture scale",
    description="Displacement texture scale for the material",
    default=(1.0, 1.0),
    subtype='NONE',
    size=2,
    min=0.0, max=1.0
  ...
  dissolve_texture: StringProperty(
    name="Dissolve texture",
    description="Dissolve texture for the material",
    default="",
    subtype='FILE_PATH'
  )
  dissolve_texture_scroll_angle: FloatProperty(
    name="Dissolve texture scroll angle",
    description="Dissolve texture scroll angle for the material",
    default=0
  )
  dissolve_texture_scroll_rate: FloatProperty(
    name="Dissolve texture scroll rate",
    description="Dissolve texture scroll rate for the material",
    default=0
  )
  dissolve_texture_scale: FloatVectorProperty(
    name="Dissolve texture scale",
    description="Dissolve texture scale for the material",
    default=(1.0, 1.0),
    subtype='NONE',
    size=2,
    min=0.0, max=1.0
  )
  dissolve_glow: FloatVectorProperty(
    name="Dissolve glow color",
    description="Dissolve glow color for the material",
    subtype='COLOR',
    default=(1.0, 1.0, 1.0),
    min=0.0, max=1.0
  )
  dissolve_glow_range: FloatProperty(
    name="Dissolve glow range",
    description="Dissolve glow range for the material",
    default=0,
    min=0.0, max=0.5
  )
  dissolve_glow_falloff: FloatProperty(
    name="Dissolve glow falloff",
    description="Dissolve glow falloff for the material",
    default=0,
    min=0.0, max=1.0
  )
  dissolve_amount: FloatProperty(
    name="Dissolve amount",
    description="Dissolve amount for the material",
    default=0,
    min=0.0, max=1.0
  )
  ...
  decal_group: IntProperty(
    name="Decal group",
    description="Decal group for the material",
    default=0
  )
  ...
  distance_alpha_blend: FloatProperty(
    name="Distance alpha blend",
    description="Transparency based on view distance",
    default=0.0
  )
...
def mat_export(selected_obj):
  ...
  blend = selected_obj.mat_properties.blend
  dissolve_glow = selected_obj.mat_properties.dissolve_glow
  toon_light_dir = selected_obj.mat_properties.toon_light_dir

  texture_scale = selected_obj.mat_properties.texture_scale
  secondary_texture_scale = selected_obj.mat_properties.secondary_texture_scale
  displacement_map_scale = selected_obj.mat_properties.displacement_map_scale
  dissolve_texture_scale = selected_obj.mat_properties.dissolve_texture_scale
  ...
  obj["Blend"] = [blend[0], blend[1], blend[2], blend[3]]
  ...
  obj["TextureScale"] = [texture_scale[0], texture_scale[1]]
  obj["TextureBlendMode"] = selected_obj.mat_properties.texture_blend_mode
  ...
  obj["SecondaryTextureScale"] = [secondary_texture_scale[0], secondary_texture_scale[1]]
  ...
  obj["DisplacementMapScale"] = [displacement_map_scale[0], displacement_map_scale[1]]
  ...
  obj["DissolveTexture"] = bpy.path.basename(selected_obj.mat_properties.dissolve_texture)
  obj["DissolveTextureScrollAngle"] = selected_obj.mat_properties.dissolve_texture_scroll_angle
  obj["DissolveTextureScrollRate"] = selected_obj.mat_properties.dissolve_texture_scroll_rate
  obj["DissolveTextureScale"] = [dissolve_texture_scale[0], dissolve_texture_scale[1]]
  obj["DissolveGlow"] = [dissolve_glow.r, dissolve_glow.g, dissolve_glow.b]
  ...
  obj["DistanceAlphaBlend"] = selected_obj.mat_properties.distance_alpha_blend

  # Flipbooks
  for anim in selected_obj.material_animations:
    obj["Flipbooks"].append({
      "TextureTarget": anim.name,
  ...
  for collection in bpy.data.collections:
    ...
    for obj in collection.objects:
      for key, value in obj.mat_properties.items():
        if key in MATERIAL_FILE_PROPS and value != "":
          shutil.copyfile(bpy.path.abspath(value), path + bpy.path.basename(value))
