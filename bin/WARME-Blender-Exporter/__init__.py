...
class WARME_PG_MatProperties(bpy.types.PropertyGroup):
    ...
    toon_blending: BoolProperty(
        name="Toon blending enable",
        description="Enable toon blending for the material",
        default=True
    )
...
def mat_export(selected_obj):
  ...
  obj["Texture"] = selected_obj.mat_properties.texture
  ...
  obj["DisplacementMap"] = selected_obj.mat_properties.displacement_map
  ...
  obj["DiffuseMap"] = selected_obj.mat_properties.diffuse_map
  obj["SpecularMap"] = selected_obj.mat_properties.specular_map
  obj["EmissiveMap"] = selected_obj.mat_properties.emissive_map
  obj["NormalMap"] = selected_obj.mat_properties.normal_map
  obj["EnvMap"] = selected_obj.mat_properties.env_map
  obj["ToonMap"] = selected_obj.mat_properties.toon_map
  ...
  for collection in bpy.data.collections:
    ...
    if (collection.name == "ANY"):
      for obj in collection.objects:
        ...
        list.append(path + obj.name + '.any')
      #endfor
    #endif
  #endfor

  scene_name = os.path.basename(bpy.data.filepath)
  zip_files(list, path + scene_name + '.zip')
