...
const VERT_INSERT = WINDOW.__PARTICULES_VERT_INSERT__ ? WINDOW.__PARTICULES_VERT_INSERT__ : '';
const FRAG_INSERT = WINDOW.__PARTICULES_FRAG_INSERT__ ? WINDOW.__PARTICULES_FRAG_INSERT__ : '';
