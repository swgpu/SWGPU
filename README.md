...
The best way is to used the [WARME Blender Exporter](https://github.com/jay19240/WARME-Engine/bin/WARME-Blender-Exporter.zip).    
Otherwise you can also used any software that export file in wavefront obj format like Blender, Crocotile, Elit3D or whatever.    
